...
class Deal(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            GinIndex(fields=['title'], name='deal_title_trgm', opclasses=['gin_trgm_ops']),
            GinIndex(fields=['industry'], name='deal_industry_trgm', opclasses=['gin_trgm_ops']),
            GinIndex(fields=['sector'], name='deal_sector_trgm', opclasses=['gin_trgm_ops']),
...
class SectorResearchSourceRule(models.Model):
    """Admin-managed publisher policy used by sector research discovery."""
    ...
    query_templates = models.JSONField(default=list, blank=True)
