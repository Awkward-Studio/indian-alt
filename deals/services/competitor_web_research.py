        ...
        with ThreadPoolExecutor(max_workers=max(1, len(queries))) as executor:
            futures = {
                executor.submit(
                    ...
                    # These queries were already generated by the dedicated
                    # competitor planner above. Do not spend another model
                    # request re-planning each branch while the inference
                    # worker may be processing document/report work.
