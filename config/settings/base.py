...
VDR_ARTIFACT_SEGMENT_MAX_TOKENS = config('VDR_ARTIFACT_SEGMENT_MAX_TOKENS', default=5000, cast=int)
VDR_ARTIFACT_SEGMENT_WORKERS = config('VDR_ARTIFACT_SEGMENT_WORKERS', default=1, cast=int)
VDR_ARTIFACT_SEGMENT_TIMEOUT = config('VDR_ARTIFACT_SEGMENT_TIMEOUT', default=600, cast=int)
VDR_ARTIFACT_CACHE_TTL = config('VDR_ARTIFACT_CACHE_TTL', default=2592000, cast=int)
VDR_DOCUMENT_TASK_SOFT_TIME_LIMIT = config('VDR_DOCUMENT_TASK_SOFT_TIME_LIMIT', default=5100, cast=int)
VDR_DOCUMENT_TASK_TIME_LIMIT = config('VDR_DOCUMENT_TASK_TIME_LIMIT', default=5400, cast=int)
