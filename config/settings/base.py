...
VDR_ARTIFACT_SEGMENT_INPUT_TOKENS = config('VDR_ARTIFACT_SEGMENT_INPUT_TOKENS', default=40960, cast=int)
VDR_ARTIFACT_SEGMENT_SOURCE_TOKENS = config('VDR_ARTIFACT_SEGMENT_SOURCE_TOKENS', default=36000, cast=int)
VDR_ARTIFACT_SEGMENT_OVERLAP_TOKENS = config('VDR_ARTIFACT_SEGMENT_OVERLAP_TOKENS', default=768, cast=int)
VDR_ARTIFACT_SEGMENT_MAX_TOKENS = config('VDR_ARTIFACT_SEGMENT_MAX_TOKENS', default=16384, cast=int)
