...
def publish_table_axis_prompts(apps, schema_editor):
    ...
    for title in IC_SECTION_TITLES:
        ...
        if current and current.user_template == user_template:
            continue
...
class Migration(migrations.Migration):
    dependencies = [
        ("ai_orchestrator", "0040_publish_report_formatting_prompts"),
    ]

    operations = [
        migrations.RunPython(publish_table_axis_prompts, migrations.RunPython.noop),
    ]
